...
class MeetupModel:
    ...
    def get_specific_meetup(meeting_id):
        ...
        meetup = db.select_from_db(select_specific_query)
        return meetup
    ...
    def get_all_upcoming_meetups():
        ...
        meetups = db.select_from_db(select_all_meetup_query)
        data = []
...
class QuestionModel:
    ...
    def get_question(quiz_id):
        ...
        question = db.select_from_db(get_question_query)
        return question
    ...
    def get_all_questions(meet_id):
        ...
        questions = db.select_from_db(get_all_questions_query)
        data = []
...
class CommentModel:
    ...
    def get_all_comments(quiz_id):
        ...
        comments = db.select_from_db(get_all_comments_query)
        data = []
...
class UserModel:
    ...
    def query_users(username, password):
        ...
        return db.select_from_db(select_user_query)
    ...
    def get_user_by_username(username):
        ...
        return db.select_from_db(select_user_by_username_query)
    ...
    def get_user_questions(user_id):
        ...
        questions_list = db.select_from_db(get_user_query)
    ...
    def get_user_meetups(user_id):
        ...
        meetups = db.select_from_db(get_user_meetups_query)
        return meetups
...
class UserRsvp:
    ...
    def get_attendees(meetup_id):
        ...
        attendees_list = db.select_from_db(get_attendees_query)
...
class UserVote:
    ...
    def check_if_already_voted(user_id, question_id):
        ...
        voted = db.select_from_db(check_vote_query)
        return voted
...
class AuthToken:
    ...
    def check_if_token_blacklisted(token):
        ...
        token = db.select_from_db(check_blacklist_token_query)
        return token  